...
// ── US alerts ─────────────────────────────────────────────────────────────────
export const initialAlertsUS: FleetAlert[] = [
  {
    id: 'alert-001',
    severity: 'critical',
...
// ── MX alerts ─────────────────────────────────────────────────────────────────
export const initialAlertsMX: FleetAlert[] = [
  {
    id: 'alert-mx-001',
    severity: 'critical',
...
// ── UK alerts ─────────────────────────────────────────────────────────────────
export const initialAlertsUK: FleetAlert[] = [
  {
    id: 'alert-uk-001',
    severity: 'critical',
...
// ── Region map ─────────────────────────────────────────────────────────────────
export const alertsByRegion: Record<RegionCode, FleetAlert[]> = {
  us: initialAlertsUS,
  mx: initialAlertsMX,
  uk: initialAlertsUK,
}
