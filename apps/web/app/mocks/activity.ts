...
// ── US events ─────────────────────────────────────────────────────────────────
export const mockEventsUS: ActivityEvent[] = [
  {
    id: 'evt-001',
    type: 'hos_violation',
    driverId: 'DRV-005',
...
// ── MX events ─────────────────────────────────────────────────────────────────
export const mockEventsMX: ActivityEvent[] = [
  {
    id: 'evt-mx-001',
    type: 'hos_violation',
    driverId: 'DRV-MX-005',
...
// ── UK events ─────────────────────────────────────────────────────────────────
export const mockEventsUK: ActivityEvent[] = [
  {
    id: 'evt-uk-001',
    type: 'hos_violation',
    driverId: 'DRV-UK-005',
...
// ── Region map ─────────────────────────────────────────────────────────────────
export const eventsByRegion: Record<RegionCode, ActivityEvent[]> = {
  us: mockEventsUS,
  mx: mockEventsMX,
  uk: mockEventsUK,
}
